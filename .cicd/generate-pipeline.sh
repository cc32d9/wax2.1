...
cat <<EOF
  - label: ":darwin: macOS 10.14 - nodeos_forked_chain_lr_test"
    command:
      ...
      - "cd eos && buildkite-agent artifact download build.tar.gz . --step ':darwin: macOS 10.14 - Build' --build bcebee17-d3f9-42f1-9216-a42aa721c970 && tar -xzf build.tar.gz"
